<?php $__env->startSection('konten'); ?>
    ...
    <div class="satu bg-white w-100 vh-100 d-flex justify-content-evenly flex-row align-items-center">
        <div class="left marlef w-50 ms-5">
            <div class="mb-5 mt-5 atas">
                <span class="h1 text-black"
                    style="font-family: 'Montserrat'; font-weight: 600; font-size: 4em;"><?php echo app('translator')->get('jadwal.judul'); ?></span><br>
            </div>
            <div class="kiri vib" style="width: 90%">
                <span><?php echo app('translator')->get('jadwal.deskripsi'); ?></span>
            </div>
            <div class="tombol">
                <button onclick="window.location.href='<?php echo e(route('login')); ?>'"
                    ...
                    style="background-color: #72B5F6; font-weight: 500; border-radius: 20px; width: 250px; height: 50px"><i
                        class="fa-solid fa-rocket me-2"></i> <?php echo app('translator')->get('jadwal.btn_coba_fitur'); ?></button>
                <button type="button" class="bawah lihat btn btn-secondary shadow ms-4 mb-3 mt-5" data-bs-toggle="modal"
                    data-bs-target="#modalVideo" style="border-radius: 20px; width: 200px; height: 50px"><i
                        class="fa-regular fa-circle-play me-2 fs-5"></i> <?php echo app('translator')->get('jadwal.btn_lihat_tutor'); ?></button>
                <iframe class="video shadow-lg w-100" style="height: 190px" src="<?php echo e(__('jadwal.video')); ?>"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-body d-flex justify-content-center align-items-center">
                                <iframe class="w-100 h-100" src="<?php echo e(__('jadwal.video')); ?>" title="YouTube video player"
                                    frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
        ...
        <img class="shadow-lg blob mt-5 kanan" src="<?php echo e(asset('storage/images/' . __('jadwal.gambar'))); ?>"
        ...
        <div class="w-50 d-flex fitir justify-content-center flex-column mb-5">
            <div class="kiri d-flex flex-column">
                <span class="fs-2 unggul fw-bold"
                    style="color: #72B5F6; font-family: 'Montserrat';"><?php echo app('translator')->get('jadwal.judul_keunggulan'); ?></span>
                <span class="my-4"><?php echo app('translator')->get('jadwal.deskripsi_keunggulan'); ?></span>
                <div class="fitur d-flex justify-content-start flex-row mt-4">
                    <?php $__currentLoopData = $fitures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.headerAsli', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\vibefour\resources\views/produk/produkPenjadwalan.blade.php ENDPATH**/ ?>