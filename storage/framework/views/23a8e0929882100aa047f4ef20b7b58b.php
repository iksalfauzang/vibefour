...
<?php $__env->startSection('konten'); ?>
    ...
    <div class="bg-white satu vh-100 w-100 d-flex justify-content-around flex-column align-items-center">
        <div class="text w-75 d-flex justify-content-around flex-column align-items-center">
            <span class="atas px-2 py-1 rounded-pill text-primary"
                style="background-color: rgba(114, 181, 246, 0.4);"><?php echo app('translator')->get('about.judul'); ?></span>
            <h1 class="atas h1 mt-4 text-center" style="font-weight: 600; font-size: 4em; font-family: 'Montserrat';">
                <?php echo app('translator')->get('about.slogan'); ?></h1>
            <p class="bawah hadir text-center mt-5" style="width: 45rem"><?php echo app('translator')->get('about.deskripsi'); ?></p style="width: 40rem">
            <a href="<?php echo e(route('login')); ?>">
                <button class="bawah btn masyuk mt-4"
                    style="background-color: #72B5F6; color: #FFF; font-weight: 500; border-radius: 20px; width: 415px; height: 50px"><i
                        class="fa-solid fa-door-open me-2"></i> <?php echo app('translator')->get('about.masuk'); ?></button>
            </a>
        </div>
    </div>
    ...
    <div class="bg-white atas w-100 d-flex justify-content-around flex-column align-items-center"
        ...
        <span class="fs-1 fw-bold mb-4" style="color: #000; font-family: 'Montserrat';"><?php echo app('translator')->get('about.judul_tentang'); ?></span>
        <span class="fs-5 w-75 text-center"><?php echo app('translator')->get('about.desk_tentang'); ?></span>
    </div>
    ...
    <div class="bg-white visi d-flex justify-content-around flex-row align-items-center" style="margin-bottom: 150px">
        <div class="kiri cisi d-flex flex-column text-center" style="width: 500px">
            <span class="fs-3 fw-bold mb-4" style="color: #000; font-family: 'Montserrat';"><?php echo app('translator')->get('about.vote'); ?></span>
            <span class="fs-5"><?php echo app('translator')->get('about.desk_vote'); ?></span>
        </div>
        <div class="kanan cisi d-flex flex-column text-center" style="width: 500px">
            <span class="fs-3 fw-bold mb-4" style="color: #000; font-family: 'Montserrat';"><?php echo app('translator')->get('about.jadwal'); ?></span>
            <span class="fs-5"><?php echo app('translator')->get('about.desk_jadwal'); ?></span>
        </div>
    </div>
    ...
    <div class="bg-light w-100 mt-5 d-flex justify-content-around flex-column align-items-center" style="padding: 80px 0">
        <h2 class="fw-bold mb-4 atas" style="font-family: 'Montserrat';"><?php echo app('translator')->get('about.judul_visi_misi'); ?></h2>
        <div class="w-75 text-center">
            <div class="atas bg-white vm p-4 shadow rounded bg-white text-dark">
                <h4 class="fw-bold" style="font-family: 'Montserrat';"><?php echo app('translator')->get('about.judul_visi'); ?></h4>
                <p><?php echo app('translator')->get('about.desk_visi'); ?>
                </p>
            </div>
        </div>
        <div class="d-flex w-75 justify-content-between mt-4 text-center">
            <?php $__currentLoopData = $missions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div style="width: 49%" class="kiri p-3 vm border rounded shadow-sm bg-white">
                    <h5 class="mt-2" style="font-family: 'Montserrat';"><?php echo e($mission->nama); ?></h5>
                    <p><?php echo e($mission->isi); ?></p>
                </div>
    ...
    <section class="keunggulan-section text-center" style="padding: 80px 0">
        <div class="container">
            <h2 class="atas fw-bold mb-5" style="font-family: 'Montserrat';"><?php echo app('translator')->get('about.judul_keunggulan'); ?></h2>
            <div class="row">
                <?php $__currentLoopData = $advantages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $advantage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="kiri keunggulan col-md-4">
                        <div class="keunggulan-card">
                            <?php echo $advantage->ikon; ?>

                            <h5 class="mt-3" style="font-family: 'Montserrat';"><?php echo e($advantage->nama); ?></h5>
                            <p><?php echo e($advantage->isi); ?></p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php echo $__env->make('layout.headerAsli', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\vibefour\resources\views/tentang.blade.php ENDPATH**/ ?>