        ...
        <div class="form-container position-relative" style="width: 75%; height: 70%; margin-top: 70px;">
            <div class="daftar card shadow-sm d-flex flex-row overflow-hidden w-100 h-100" style="border-radius: 20px;">
                <div class="left w-50 h-100 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p class="w-75 mb-4 forum text-center"><?php echo app('translator')->get('otp.ket'); ?></p>
                    ...
                    <div class="daftar otp text-center w-75">
                        ...
                        <?php else: ?>
                            <a style="text-decoration: none; color: #000" href="<?php echo e(route('resend.otp')); ?>"
...
<?php echo $__env->make('layout.headerAsli', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\vibefour\resources\views/Auth/otpRegis.blade.php ENDPATH**/ ?>